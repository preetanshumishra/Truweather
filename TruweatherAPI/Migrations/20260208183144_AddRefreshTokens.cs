        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SavedLocationId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WeatherAlerts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WeatherAlerts_SavedLocations_SavedLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cloudiness = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Precipitation = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Uvi = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WeatherData_SavedLocations_SavedLocationId",
                        column: x => x.SavedLocationId,
                        principalTable: "SavedLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeatherAlerts_SavedLocationId",
                table: "WeatherAlerts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeatherData_SavedLocationId_Date",
                table: "WeatherData",
                columns: new[] { "SavedLocationId", "Date" });
        }
